...
light.position.set(-2,2.5,-6);                           // WCS coords for light
...
var raytracerMaterial = new THREE.ShaderMaterial( {     
  ...
  vertexShader: document.getElementById( 'raytraceVertShader' ).textContent,
  fragmentShader: document.getElementById( 'raytraceFragShader' ).textContent
} );
...
screenGeometry = new THREE.PlaneBufferGeometry(10,10);
...
function update() {
  ...
  if (animate) {
      var i = Math.sin(Date.now()*0.001);
      raytracerMaterial.uniforms.myFloat1.value = i;
      raytracerMaterial.uniforms.myFloat1.needsUpdate = true;
      var i2 = Math.cos(Date.now()*0.001);
      raytracerMaterial.uniforms.myFloat2.value = i2;
      raytracerMaterial.uniforms.myFloat2.needsUpdate = true;
      var i3 = Math.cos(Date.now()*0.001);
      raytracerMaterial.uniforms.myFloat3.value = i3;
      raytracerMaterial.uniforms.myFloat3.needsUpdate = true;
      var i4 = Math.sin(Date.now()*0.001);
      raytracerMaterial.uniforms.myFloat4.value = i4;
      raytracerMaterial.uniforms.myFloat4.needsUpdate = true;
  }
  renderer.render(scene, camera);
  raytracerMaterial.uniforms.maxBounces.value = maxBounces;
  raytracerMaterial.uniforms.maxBounces.needsUpdate = true;
}
